  ...
  return (
    <div className="animate-fade-in flex flex-col items-center justify-center py-8">
      ...
      <p className="text-gray-600 text-center mb-6 max-w-sm text-balance">
        Obrigado pelo seu interesse nas soluções da TR Energia. Nossa equipe entrará em contato o mais breve possível com as instruções de assinatura.
      </p>
      ...
      <div className="bg-trenergia-gray p-4 rounded-lg max-w-sm">
        <p className="text-sm text-gray-600 flex items-start">
          ...
          <span>
            <span className="font-medium">Próximos passos:</span> Iremos fazer a confecção do seu contrato para que em breve você possa aproveitar o desconto exclusivo.
          </span>
        </p>
      </div>
